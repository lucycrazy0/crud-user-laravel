    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('user.index') }}"><i class="material-icons d-inline-block align-top">&#xE01D;</i>Dashboard <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="{{ route('user.index') }}"><i class="material-icons d-inline-block align-top">&#xE7FB;</i> List User</a>
                        <a class="dropdown-item" href="{{ route('user.create') }}"><i class="material-icons d-inline-block align-top">&#xE7F0;</i> Add User</a>
                    </div>
                </li>
            </ul>
            @guest
            ...
            <div class="dropdown mr-5">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{ '/admin/user/'.Auth::user()->id }}"><i class="material-icons">&#xE869;</i> Settings</a>
