<nav class="navbar navbar-expand-lg navbar-info bg-light container-fluid">
    <a class="navbar-brand" href="#">
        <img src="img/logo.svg" width="30" height="30" alt="" class="d-inline-block align-top"> Admin Laravel
    </a>
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="dropdown mr-4">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="#"><i class="material-icons">&#xE869;</i> Settings</a>
