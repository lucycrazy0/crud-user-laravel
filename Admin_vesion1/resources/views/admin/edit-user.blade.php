        ...
        <form>
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" value="{{$admin->name}}" aria-describedby="emailHelp" placeholder="Enter Name ...">
                </div>
                <div class="form-group">
                ...
                <textarea class="form-control" id="exampleTextarea" rows="3" placeholder="Enter Address ..."></textarea>
                </div>
            </fieldset>
        </form> 
    </div>            
